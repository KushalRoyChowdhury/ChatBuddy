...
### Changed
- Switched Advance model from Gemini 2.5 Lite to Gemini 3.1 Lite.

## [2.5.0] - 2025-12-05

### Changed
- Redesigned UI for more moddern & coherent look.
- Added support for upto 10 files in single prompt.
