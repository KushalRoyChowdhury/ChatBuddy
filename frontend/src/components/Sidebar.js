  ...
  const mobileSidebar = (
    <>
      ...
      <div ref={mobileSidebarRef} className={`fixed top-0 left-0 h-full z-50 sidebar hide -translate-x-full`} >
        ...
        <div className={`w-96 max-w-[80vw] h-full border-r shadow-2xl rounded-r-2xl flex flex-col transition-colors duration-300 ${glassMode ? 'bg-white/50 border-white/60 dark:bg-[rgb(50,50,50)]/50 dark:border-white/50' : 'bg-gray-50 dark:bg-[rgb(50,50,50)] border-gray-200 dark:border-gray-700'}`}>
