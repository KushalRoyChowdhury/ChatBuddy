                        ...
                        <div className="p-6 overflow-y-auto flex-grow space-y-6 custom-scrollbar">
                            <div>
                                ...
                                <p className="text-xs text-amber-800 dark:text-amber-200 mt-3 p-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/50 rounded-lg">
                                    ...
                                    larger Context Window. PUBLIC ACCESS has stricter Rate Limits and
                                    limited Context Window. Changing API KEY does not change model behavior/personality.
                                </p>
                            </div>
                            ...
                            <div className='border border-gray-200 dark:border-gray-700 p-3 rounded-xl bg-gray-50/50 dark:bg-black/20'>
                                <div className="text-sm font-medium text-gray-900 dark:text-white mb-3">
                                    Today's Usage <span className='text-xs text-gray-500 font-normal dark:text-gray-400 italic'>(BETA)</span>
                                </div>

                                <div className="space-y-3 pr-3">
                                    <div className='flex items-center gap-3'>
                                        <div className='w-24 text-sm text-gray-600 dark:text-gray-300'>Basic Model</div>
                                        <div title={`${Math.round((usage.basic / (apiKey.trim().length === 39 ? 1500 : 200)) * 100)}%`} className="flex-1 h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                            <div
                                                className={`h-full rounded-full ${(usage.basic / (apiKey.trim().length === 39 ? 1500 : 200) * 100) < 40 ? 'bg-green-500' :
                                                    (usage.basic / (apiKey.trim().length === 39 ? 1500 : 200) * 100) < 80 ? 'bg-yellow-500' : 'bg-red-500'
                                                    }`}
                                                style={{ width: `${(usage.basic / (apiKey.trim().length === 39 ? 1500 : 200)) * 100}%` }}
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className='flex items-center gap-3'>
                                        ...
                                        <div title={`${Math.round((usage.advance / (apiKey.trim().length === 39 ? 500 : 50)) * 100)}%`} className="flex-1 h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                            <div
                                                className={`h-full rounded-full ${(usage.advance / (apiKey.trim().length === 39 ? 500 : 50) * 100) < 40 ? 'bg-green-500' :
                                                    (usage.advance / (apiKey.trim().length === 39 ? 500 : 50) * 100) < 80 ? 'bg-yellow-500' : 'bg-red-500'
                                                    }`}
                                                style={{ width: `${(usage.advance / (apiKey.trim().length === 39 ? 500 : 50) * 100)}%` }}
                                            />
                                        </div>
                                    </div>
                        ...
                        <div className="p-6 overflow-y-auto font-normal flex-grow space-y-6 custom-scrollbar">
                            <div className="p-5 bg-gray-50 dark:bg-white/5 rounded-xl border border-gray-100 dark:border-gray-700/50">
                                <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                                    ...
                                    <br /><br />
                                    Basic model: <span className="font-semibold text-gray-900 dark:text-white">Gemma 4 31B.</span> Best for Conversation & Role-Plays.
                                    <br /><br />
                                    Advanced model: <span className="font-semibold text-gray-900 dark:text-white">Gemini 3.1 Lite.</span> Best for Coding, Math, Reasoning & Web Tasks.
                                    <br /><br />
                                    ...
                                    <br /><br />
                                    You can add your Gemini API key for Higher Rate Limits and Context Window (upto ~128k).
                                    <br /><br />
                                    Basic Model Supports ~12k Context Window. Advance Model Supports ~64k Context Window (DEMO ACCESS).
                                    <br /><br />
                                    Rate Limits in DEMO ACCESS are: Basic Model (5RPM / 100 RPD), Advance Model (3 RPM / 50 RPD){imageGenAvailable && ', Image Generation (1RPM, 25RPD)'}.
                                    <br /><br />
                                    Rate Limits in PERSONAL KEY ACCESS are: Basic (30 RPM / 1,500 RPD), Advance (15 RPM / 500 RPD){imageGenAvailable && ', Image Generation (10RPM, 100RPD)'}.
                                    <br /><br />
