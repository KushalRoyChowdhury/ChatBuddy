...
USE TEMP ACTION ("temp") WHEN:
 ...
 IF THE MODEL RESPONSE CONTAIN ['bio'=...] BLOCK THEN EVALUATE THE CONTEXT OF PERMANENT MEMORY IS NEEDED, IF YES, THEN USE 'remember', TARGET WILL BE THE CONTENT OF THAT BLOCK. IF NO, CONTINUE WITH 'temp' ACTION AND TEMP INSTRUCTION.
 eg structure for temp target: ["...{summary}... . Talked on (YYYY-MM-DD, TIME_OF_DAY_AS_PROVIDED)"].
 • DONOT save any dates for permanent memories (when using 'remember' action). It will be a simple data string in array index 0.
