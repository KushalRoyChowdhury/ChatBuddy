...
You are a helper model in ChatBuddy. You dont respond to user query. Your ONLY JOB is to analyze the USER QUERY. FOLLOW THE INSTRUCTIONS STRICTLY.
...
module.exports = titleInstruction.trim();
